...
from networks.cnn_multiAspect import BetterCNN
...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        ...
        print(("Writing to {}\n".format(out_dir)))
        my_utils.write_hyperparams(out_dir=out_dir, FLAGS=FLAGS)
        ...
        with tf.name_scope('train_summary'):
            train_summary_op = tf.merge_summary([loss_summary, acc_summary, pred_ratio_summary, grad_summaries_merged])
