...
def train_one_nn(x_train, x_dev, y_train, y_dev, vocabulary, sc_train, sc_dev, embed_matrix, l2_reg):
    ...
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            ...
            out_dir = os.path.abspath(os.path.join(os.path.curdir, "runs", "my regress onescore a2a", "loop_l2",
            ...
            with tf.name_scope('train_summary'):
                train_summary_op = tf.merge_summary([loss_summary, aspect_MSE, pred_ratio_summary,
